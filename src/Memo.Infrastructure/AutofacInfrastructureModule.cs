...
using Autofac;
using Memo.Core.ContributorAggregate;
using Memo.Core.Interfaces;
using Memo.Infrastructure.Data;
using Memo.Infrastructure.Data.Queries;
using Memo.Infrastructure.Email;
using Memo.UseCases.Contributors.Create;
using Memo.UseCases.Contributors.List;
using MediatR;
